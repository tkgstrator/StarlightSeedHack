<template>
  <v-container fluid>
    ...
    <v-container class="table">
      <v-data-table :headers="headers" :items="mGameSeed" :items-per-page="20" :mobile-breakpoint="360" dark hide-default-footer dense></v-data-table>
    </v-container>
  </v-container>
</template>
...
export default {
  ...
  methods: {
    generate() {
      ...
      const mGameSeed = [this.mInitialSeed, rnd.getU32(), rnd.getU32()]
